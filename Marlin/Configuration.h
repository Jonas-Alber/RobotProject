...
#define STRING_CONFIG_H_AUTHOR "(none, scara config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_SCARA_CONTROLLER
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_2 3 //TODO:Disabled Serial Port 2 to check if it is the problem which initializes UART
...
//#define MP_SCARA
  ...
  #define SCARA_OFFSET_Y  -110       // (mm)
    ...
    #define MIDDLE_DEAD_ZONE_R   70  // (mm)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 142, 142, 400, 500 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 30, 30, 5, 25 }//{ 300, 300, 5, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10, 10, 10, 1000 }//{ 300, 300, 100, 1000 }
